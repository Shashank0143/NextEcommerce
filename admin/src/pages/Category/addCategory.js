...
const AddCategory = () => {
  ...
  const addCat = (e) => {
    ...
    if (
      ...
      formFields.metaDescription !== "" &&
      formFields.metaKeywords !== "" &&
      formFields.metaHOneTag !== "" &&
      previews.length !== 0
    ) {
      setIsLoading(true);
      // console.log("FormFeilds: ",formFields)
