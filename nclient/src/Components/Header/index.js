...
import { FaAngleLeft, FaRegUser, FaAngleUp } from "react-icons/fa6";
  ...
  return (
    <>
      ...
      <div className="headerWrapperFixed" ref={headerRef}>
        <div className="headerWrapper">
          <div className="top-strip bg-black"> 
            <div className="container">
              <p className="marquee-text mb-0 mt-0 text-center">
                <span style={{fontWeight:"bold"}}>Flat 60% Off</span> on All Products! Limited Time Offer!
              </p>
            </div>
          </div>
          ...
          <header className="header bg-blue">
            <div className="container">
              <div className="row">
                ...
                <div
                  className={`logoWrapper d-flex align-items-center ${
                    context.windowWidth < 992 ? "col-sm-12" : "col-sm-2"
                  }`}
                  style={{
                    width: "100%",
                    justifyContent: context.windowWidth < 992 ? "center" : "flex-start"
                  }}
                >
                  {context.windowWidth < 992 && (
                    <Button className="toggleNav" onClick={openNav}>
                      <IoMdMenu style={{color:"white"}} />
                    </Button>
                  )}

                  <Link href={"/"} className="logo" style={{textDecoration:"none"}}>
                    <div className="logotext" style={{display:'flex', flexDirection:"column", }}>
                      <span style={{fontSize:"1.6rem", textAlign:"center", color:"white" }}>P & H</span>
                      <span style={{fontSize:"0.6rem", marginTop:"-10px",color:"white"}}>BY PRIYANSHU</span>
                    </div>
                  </Link>
        ...
        {context.windowWidth < 992 && true && (
          <div className="fixed-bottom-menu d-flex align-self-center justify-content-between bg-blue">
            <Link href="/" onClick={() => setIsOpenSearch(false)}>
              <Button className="circle">
                <div className="d-flex align-items-center justify-content-center flex-column">
                  <IoHomeOutline/>
                  <span className="title white-icon">Home</span>
                </div>
              </Button>
            </Link>
            ...
            {context.enableFilterTab === true && (
              <Button className="circle" onClick={() => {
                ...
                <div className="d-flex align-items-center justify-content-center flex-column">
                  <CiFilter />
                  <span className="white-icon">Filters</span>
                </div>
              </Button>
            )}
            ...
            <Button className="circle" onClick={openSearch }>
              <div className="d-flex align-items-center justify-content-center flex-column">
                <IoIosSearch />
                <span className="title white-icon">Search</span>
              </div>
            </Button>

            <Link href="/myList"  onClick={() => setIsOpenSearch(false)}>
              <Button className="circle">
                <div className="d-flex align-items-center justify-content-center flex-column">
                  <IoMdHeartEmpty />
                  <span className="title white-icon">Wishlist</span>
                </div>
              </Button>
            </Link>

            <Link href="/orders"  onClick={() => setIsOpenSearch(false)}>
            <Button className="circle">
              <div className="d-flex align-items-center justify-content-center flex-column">
                <IoBagCheckOutline />
                <span className="title white-icon">Orders</span>
              </div>
            </Button>
          </Link>
            

            <Link href="/myAccount"  onClick={() => setIsOpenSearch(false)}>
              <Button className="circle">
                <div className="d-flex align-items-center justify-content-center flex-column">
                  <FaRegUser />
                  <span className="title white-icon">Account</span>
                </div>
              </Button>
            </Link>
          </div>
