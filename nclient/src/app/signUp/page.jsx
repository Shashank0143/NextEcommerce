  ...
  return (
    <section className="section signInPage signUpPage bg-blue">
      ...
      <div className="container">
        <div className="box card p-1 shadow border-0">
          <div className="text-center">
            <Image src={Logo} alt="image" width={130} height={140} />
          </div>

          <form className="mt-1" onSubmit={register}>
            ...
            >
              <Image src={GoogleImg} alt="image" height={35} width={50} /> Sign In with Google
            </Button>
          </form>
        </div>
      </div>
