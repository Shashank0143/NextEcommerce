...
const Listing = ({ params }) => {
    ...
    const getMetaData = (categoryId) => {
        const metaDataMap = {
            'men-suits': {
                title: "Shop Men’s Suits - Elegant & Modern Collection for Weddings & Formal Wear",
                description: "Browse through our exquisite collection of men’s suits. Perfect for weddings, business meetings & formal events. Discover tailored suits designed for comfort & style. Shop today for the best deals!",
