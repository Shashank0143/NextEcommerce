...
const Listing = ({ params }) => {
    ...
    const getMetaData = (categoryId) => {
        const metaDataMap = {
            ...
            't-shirts': {
                title: "Buy Latest Men's T-shirts Online at Best Price | P&H by Priyanshu",
                description: "Men's T-shirts - Buy T-shirts for men online in India. Choose from a wide range of polo, round, V neck & more Men's T-shirts in various designs at P&H by Priyanshu",
                ...
                htag: "Men T-Shirts",
                url: "https://phbypriyanshu.com/category/t-shirts"
            },
